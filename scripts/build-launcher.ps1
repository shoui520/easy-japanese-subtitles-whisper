...
& $compiler /nologo /target:winexe /platform:x64 /optimize+ $defines /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.Web.Extensions.dll "/out:$output" (Join-Path $project 'launcher\Program.cs') (Join-Path $project 'launcher\SetupWindow.cs') (Join-Path $project 'launcher\ProcessJob.cs')
